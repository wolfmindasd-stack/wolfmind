...
import { TrendingUp, TrendingDown, Users, Receipt, AlertTriangle, Wallet } from "lucide-react";
...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-8" data-testid="dashboard-page">
      <div>
        <div className="wm-label">Dashboard</div>
        <h1 className="font-display text-4xl font-black tracking-tighter mt-2">Panoramica</h1>
        <p className="text-white/50 mt-2 text-sm">Le metriche chiave del gestionale in tempo reale.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <KpiCard title="Tesserati totali" value={d.tesserati_count} icon={Users}
        ...
        <KpiCard title="Uscite (anno)" value={fmtEur(d.uscite_anno)} icon={TrendingDown}
          color="text-[#FF3B30]" testid="kpi-uscite" />
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="wm-card p-6 lg:col-span-1">
          <div className="wm-label mb-4">Saldo anno</div>
